...
setup-x86.exe --packages xorg-server,xorg-server-common,xorg-x11-fonts-misc,xorg-x11-fonts-dpi75,xorg-x11-fonts-dpi100,xauth,xterm,xset,xmag,xkill,xinit --quiet-mode
